...
<body>
    <div class="detail-container1" style="width:680px; display: block;">
		...
		<div class="form-box">
			...
			<div class="content">상품명 입력</div>
			<input id="name" name="name" placeholder="상품명"/>
		</div>

		<div class="form-box">
			<div class="title">상품소개<font style="color:red;">*</font></div>
			<div class="content">상품 소개 입력</div>
		...
		<div class="form-box">
			...
			<div class="content">회사 입력</div>
			<input type="text" id="company" placeholder="회사명"/>
		</div>

		<div class="form-box">
			<div class="title">가격<font style="color:red;">*</font></div>
			<div class="content">가격 입력 (단위 : 원)</div>
			<input type="number"id="price" placeholder="20000"/>
		</div>

		<div class="form-box">
			<div class="title">기본 할인<font style="color:red;">*</font></div>
			<div class="content">기본 할인율 입력 (단위 %)</div>
			<input type="number"id="discount" placeholder="10"/>
		</div>

		<div class="form-box">
			<div class="title">해당 할인 여부 선택</div>
			<div class="content" style="display:flex; gap:10px;">
				<div class="form-box">
					<div class="title" style="margin-bottom:10px;">시즌 할인<font style="color:red;">*</font></div>
					<input type="checkbox" class="custom-checkbox" id="season_discount"/>
					<label for="season_discount" class="custom-checkbox"></label>
				</div>
				
				<div class="form-box">
					<div class="title" style="margin-bottom:10px;">특가 할인<font style="color:red;">*</font></div>
					<input type="checkbox" class="custom-checkbox" id="special_sale"/>
					<label for="special_sale" class="custom-checkbox"></label>
				</div>
			</div>
		</div>
		...
		<div class="form-box">
			...
			<div>
				<div id="img-upload-box" class="img-upload-box">
					...
					<div style="font-size:13px;color:#585858;">대표이미지 등록</div>
				</div>
		...
		<div class="form-box">
			<div class="title">상세 이미지<font style="color:red;">*</font></div>
			<div class="content bg">
